class Frequent_Pattern:
    ...
    def handle_data(self):
        ...
        self.line_one_measure = sorted(self.line_one_input_data_lst)[int(len(self.line_one_input_data_lst) / 3 )]
        self.line_two_measure = sorted(self.line_two_input_data_lst)[int(len(self.line_two_input_data_lst) / 3 )]
        self.line_three_measure = sorted(self.line_three_input_data_lst)[int(len(self.line_three_input_data_lst) / 2 )]
        self.line_four_measure = sorted(self.line_four_input_data_lst)[int(len(self.line_four_input_data_lst) / 2 )]
        self.line_five_measure = sorted(self.line_five_input_data_lst)[int(len(self.line_five_input_data_lst) / 2 )]
        self.line_six_measure = sorted(self.line_six_input_data_lst)[int(len(self.line_six_input_data_lst) / 2 )]
